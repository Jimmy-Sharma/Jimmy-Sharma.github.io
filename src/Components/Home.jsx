      ...
      <div className="backgroundIMG">
        ...
        <div>
          ...
          <div className="contact" data-aos="fade-up">
            ...
            <button id="resume-button-2" onClick={handleClickHome}><a id="resume-link-2" href="https://drive.google.com/uc?export=download&id=11hj-XAex1zlYmribSLNlV4LQ5Eg-5js6" target="blank"><FaFileDownload className="icon" /></a></button>
          </div>
        </div>
      </div>
